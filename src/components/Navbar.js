        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="/Dashboard"
                className="flex no-underline items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100"
              >
                <svg
                  aria-hidden="true"
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3 text-gray-500">Inventory</span>
              </a>
            </li>
          </ul>
        </div>
